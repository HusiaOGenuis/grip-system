...
def landing():
    ...
    <body style="font-family: Arial; padding: 40px;">
        ...
        <p>
        A decision-grade governance and risk intelligence platform that helps
        organizations evaluate, validate, and track decisions.
        </p>

        <h3>How it works</h3>
        <ol>
            <li>Login</li>
            <li>Submit decision score</li>
            <li>System evaluates risk</li>
            <li>Receive decision output</li>
        </ol>

        /appOpen Application</a>
...
def decision(payload: dict):
    ...
    return {
        "verdict": "APPROVED" if int(score) > 50 else "REJECTED",
...
def terms():
    return "<h1>Terms of Service</h1><p>Use responsibly.</p>"

@app.get("/privacy", response_class=HTMLResponse)
def privacy():
    return "<h1>Privacy Policy</h1><p>No data is sold.</p>"import os
from typing import Dict, Any
from dotenv import load_dotenv
...
def landing():
    ...
    <body style="font-family: Arial; padding: 40px;">
        <h1>GRIP Systems</h1>
        <p>A decision-grade governance and risk intelligence platform that helps organizations evaluate, validate, and track critical operational decisions with confidence.</p>
        <a href="/login">Login</a><br><br>
        <a href="/capabilities">Capabilities</a><br><br>
        <h2>How it works</h2>
        <ol>
            <li>User logs in</li>
            <li>Submits decision input (e.g. risk score)</li>
            <li>GRIP evaluates governance compliance</li>
            <li>Returns decision with rationale and confidence</li>
        </ol>
...
def privacy():
    ...
    <body style="font-family: Arial; padding: 40px;">
        ...
        <p>We do not sell user data. Data is used strictly for providing GRIP services.</p>
    </body>
    </html>
    """
...
def terms():
    ...
    <body style="font-family: Arial; padding: 40px;">
        ...
        <p>Use of this platform is subject to governance and compliance guidelines.</p>
    </body>
    </html>
